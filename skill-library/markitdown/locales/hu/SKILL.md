...
description: >-
  Különböző fájltípusok Markdown-ká konvertálása MarkItDown segítségével: PDF, Word/PPT/Excel, képek (OCR), hang (átírás), HTML, CSV/JSON/XML, ZIP, YouTube linkek, EPub stb. Akkor használd, amikor fájlokat konvertálsz Markdown-ba jegyzeteléshez vagy modellbe töltéshez.
---
