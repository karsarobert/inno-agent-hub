...
description: >-
  Bármilyen weboldal lekérése és Markdown-ká konvertálása baoyu-fetch (Chrome CDP alapú) segítségével, beépített adapterekkel X/Twitter, YouTube feliratok, Hacker News és általános oldalak (Defuddle) kezelésére. Kezeli a bejelentkezést/CAPTCHA-t. Akkor használd, amikor weboldalakat jegzetekbe mentsz.
---
