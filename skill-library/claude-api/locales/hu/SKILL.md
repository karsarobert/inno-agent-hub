...
category: >-
  Fejlesztőeszközök
description: >-
  Claude API / Anthropic SDK alapú alkalmazások építése, hibakeresése és optimalizálása, beleértve prompt caching, eszközhívás, streaming, migráció és frissítések. Többnyelvű példák: Go/Python/TypeScript/Java/PHP. Akkor használd, amikor AI alkalmazást tanulsz vagy fejlesztesz.
---
