...
name: paper-lookup
category: >-
  Kutatás és információkeresés
description: >-
  10 tudományos irodalmi adatbázis keresése REST API-n keresztül (PubMed, PMC teljes szöveg, bioRxiv, medRxiv, arXiv, OpenAlex, Crossref, Semantic Scholar, CORE, Unpaywall) tanulmányok, preprintek és tudományos cikkek keresésére.
---
