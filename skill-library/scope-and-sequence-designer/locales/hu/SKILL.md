...
description: >-
  A tananyag körének és ütemezésének tervezése (scope & sequence): függőleges előrehaladás és vízszintes illesztés évfolyamok és félévek között, beleértve az előfeltétel-függőségeket, az tudásmozzanat-tipizálást, a kötelező és ajánlott sorrendiség feltételeit, az indoklással ellátott lépésenkénti tanítási sorrendet és a koherencia-ellenőrzéseket. Új tananyagok építésekor, tantárgyi rendszerek átszervezésekor vagy az előrehaladási útvonalak feltérképezésekor használható.
