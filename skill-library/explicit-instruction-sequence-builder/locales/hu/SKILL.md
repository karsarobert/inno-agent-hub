...
description: >-
  Teljes explicit tanítási órai sorozat felépítése: tanári bemutatás (Én csinálom) → irányított gyakorlás (Mi csináljuk) → önálló gyakorlás (Te csinálod), megértési ellenőrzőpontokkal, időkeretekkel, példákkal és gyakori hibákkal minden szakaszban, a felelősség fokozatos átadása modell alapján.
