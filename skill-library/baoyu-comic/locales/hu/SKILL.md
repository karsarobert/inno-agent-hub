...
description: >-
  Tudmányos képregény készítő eszköz: több rajzstílus és tónus támogatásával, automatikus panelelrendezés és szekvenciális képgenerálás, eredeti oktatási/ismeretterjesztő képregények készítése. Akkor használd, ha tudást képregénnyel magyaráznál. Trigger: tudományos képregény, oktatási képregény, biográfia képregény; knowledge comic, educational comic.
  Tudmányos képregény készítő eszköz: több rajzstílus és tónus támogatásával, automatikus panelelrendezés és szekvenciális képgenerálás, eredeti oktatási/ismeretterjesztő képregények készítése. Akkor használd, ha tudást képregénnyel magyaráznál. Trigger: tudományos képregény, oktatási képregény, biográfia képregény; knowledge comic, educational comic.
---
...
- **Presets** (5) with special rules beyond plain art+tone:
  ...
  | `four-panel` | minimalist + neutral + four-panel layout | bevezetés-fejlődés-fordulat-befejezés structure, B&W + spot color, stick-figure characters |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure baoyu-comic preferences" / "reconfigure"). The next run re-triggers first-time setup.
