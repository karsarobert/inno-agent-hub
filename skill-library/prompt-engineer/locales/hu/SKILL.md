...
category: >-
  Fejlesztőeszközök
description: >-
  LLM promptok írása, refaktorálása és értékelése: optimalizált prompt sablonok, strukturált kimeneti sémák, értékelési rubrikák és tesztcsomagok készítése. Új alkalmazások promptjának tervezéséhez, meglévő promptok javításához vagy trigger pontosság hibaelhárításához.
---
