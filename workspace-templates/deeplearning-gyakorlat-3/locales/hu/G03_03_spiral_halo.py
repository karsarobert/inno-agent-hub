"""Spirálpontok osztályozása ReLU rejtett réteggel.
...
# R2: 16 neuron, ráta 0.01. R3: 50–50 neuron, ráta 0.01.
# R4: az 50–50 hálózaton CSAK a rátát írd 0.001-re; epoch és batch marad.
TANULASI_RATA = 0.01
EPOCHOK = 150
BATCH_MERET = 32
VELETLEN_MAG = 42
